...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NetworkExceptions exceptions) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T? data)? success,
    TResult? Function(NetworkExceptions exceptions)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$FailureImpl<T> implements Failure<T> {
  const _$FailureImpl(this.exceptions);
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.failure(exceptions: $exceptions)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return failure?.call(exceptions);
  }
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(final NetworkExceptions exceptions) = _$FailureImpl<T>;
