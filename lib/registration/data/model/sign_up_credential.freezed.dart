...
class _$SignUpCredentialImpl implements _SignUpCredential {
  ...
  @override
  String toString() {
    return 'SignUpCredential(firstname: $firstname, lastname: $lastname, email: $email, password: $password, role: $role)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, firstname, lastname, email, password, role);
...
abstract class _SignUpCredential implements SignUpCredential {
  const factory _SignUpCredential(
      ...
      final String role}) = _$SignUpCredentialImpl;
