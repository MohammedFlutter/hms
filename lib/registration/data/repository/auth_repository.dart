...
import 'package:medica/registration/data/provider/auth_provider.dart';
...
class AuthRepository {
  ...
  Future<ApiResult<Tokens>> refreshAccessToken(String refreshToken) async {
    try {
      final tokens = await _authProvider.getAccessToken(refreshToken);
      storeTokens(tokens); //todo not responsibility
      return ApiResult.success(data: tokens);
    } catch (e) {
      return ApiResult.failure(NetworkExceptions.getDioException(e));
    }
